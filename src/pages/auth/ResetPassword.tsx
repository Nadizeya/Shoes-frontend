  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    mutate(formData, {
      onSuccess: () => {
        ...
        completeStep("resetPasswordCompleted");
        navigate("/success");
      },
      onError: (err: any) => {
    ...
    <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:h-screen sm:pr-4">
      <div className="w-full h-full flex sm:w-[50%] md:w-[60%]">
        ...
        <div className="flex items-center justify-center -ml-36 xl:-ml-48 z-10 ">
          <div className=" flex items-center justify-center mt-10 sm:bg-white w-[300px] sm:w-[250px] md:w-[300px] md:h-[350px] lg:w-[400px] lg:h-[400px] xl:w-[500px] h-[300px] xl:h-[500px] sm:h-[250px] sm:shadow-lg sm:border-r-hidden sm:rounded-l-3xl">
            <img src={Warejeans} alt="" />
          </div>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center sm:py-5 py-10 w-full sm:w-[50%] md:w-[40%] lg:w-[30%] xl:w-[35%]  md:mr-16 space-y-4 sm:shadow-lg sm:rounded-b-3xl px-4 sm:p-0">
